              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: const [
                      _ProfileInfo(label: 'Name', value: 'Farah'),
                      SizedBox(height: 12),
                      _ProfileInfo(
                          label: 'Date of birth', value: 'Mar 25, 2006'),
                      SizedBox(height: 12),
                      _ProfileInfo(label: 'phone', value: '(+91) 956232134'),
                    ],
                  ),
                ),
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: const [
                      _ProfileInfo(label: 'Email', value: 'Farah@home.com'),
                      SizedBox(height: 12),
                      _ProfileInfo(
                        label: 'Address',
                        value:
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () {},
                    icon: const Icon(Icons.logout, color: Color(0xFFC30606)),
                    label: const Text('LogOut',
                        style: TextStyle(color: Color(0xFFC30606))),
                    style: OutlinedButton.styleFrom(
                      side:
                          const BorderSide(color: Color(0xFFC30606), width: 2),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10),
                      ),
                      padding: const EdgeInsets.symmetric(vertical: 14),
...
class _ProfileInfo extends StatelessWidget {
  ...
  const _ProfileInfo(
      {required this.label, required this.value, this.isAddress = false});
